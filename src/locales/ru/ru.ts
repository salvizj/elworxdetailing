...
export const ru = {
	...
	hero: {
		title: "Авто Детейлинг Студия Elworx",
		description:
			"Услуги сертифицированного детайлера в Берги — химчистка, полировка, предпродажная подготовка, защитные покрытия, реставрация фар, озонирование",
		imageCaption:
	...
	cookie_policy: {
		...
		third_party: {
			...
			description: "Нет, мы не используем сторонние файлы cookie или трекеры.",
		},

		personal_data: {
			title: "Собираются ли личные данные?",
			description: "Личные данные или IP-адреса не собираются и не хранятся.",
		},
	},
	auto_detailing: {
		detailing: {
		...
		packages: {
			...
			every_cars_owners_dream: {
				...
				services: [
					...
					{
						title:
							"Нанесение графенового защитного покрытия на кузов автомобиля",
		...
		list: [
			...
			},
			{
				...
				sub_services: [
					...
					{
						sub_title: "Трёхступенчатая глубокая полировка автомобиля",
						description:
